        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageFormData = table.Column<byte[]>(type: "bytea", nullable: true),
                    ImageFormType = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TTUserId = table.Column<string>(type: "text", nullable: false),
                    ImageFileData = table.Column<byte[]>(type: "bytea", nullable: true),
                    ImageFileType = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketAttachments_AspNetUsers_TTUserId",
                        column: x => x.TTUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketAttachments_TTUserId",
                table: "TicketAttachments",
                column: "TTUserId");
