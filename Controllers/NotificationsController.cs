...
namespace TurboTicketsMVC.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProjectId,TicketId,SenderId,RecipientId,NotificationType,Title,Message,CreatedDate,HasBeenViewed")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProjectId,TicketId,SenderId,RecipientId,NotificationType,Title,Message,CreatedDate,HasBeenViewed")] Notification notification)
        {
