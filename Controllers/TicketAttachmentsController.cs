...
namespace TurboTicketsMVC.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.TicketAttachments.Include(t => t.TTUser).Include(t => t.Ticket);
        ...
        {
            ViewData["TTUserId"] = new SelectList(_context.Users, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,CreatedDate,TicketId,TTUserId,ImageFileData,ImageFileType")] TicketAttachment ticketAttachment)
        {
            ...
            ViewData["TTUserId"] = new SelectList(_context.Users, "Id", "Id", ticketAttachment.TTUserId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,CreatedDate,TicketId,TTUserId,ImageFileData,ImageFileType")] TicketAttachment ticketAttachment)
        {
